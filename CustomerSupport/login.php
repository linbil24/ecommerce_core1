...
<head>
    ...
    <title><?php echo $is_otp_page ? 'OTP Verification | IMARKET SUPPORT' : 'SUPPORT PORTAL LOGIN | IMARKETPH'; ?></title>
    ...
    <div class="login-container">
        <div class="header">
            <a href="login.php"
                ...
                <span class="logo-text">IMARKETPH SUPPORT <?php echo $is_otp_page ? 'VERIFICATION' : 'LOGIN'; ?></span>
            </a>
            <p style="color: var(--color-gray-500); font-size: 0.875rem; margin-top: 0.5rem;">
                ...
                if ($is_otp_page) {
                    ...
                    echo 'Enter your credentials to access the support portal. **Email OTP verification is required.**';
                }
                ?>
            </p>
        </div>
