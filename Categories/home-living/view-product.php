...
// Get product ID from URL, default to 501 if missing or invalid
$product_id = isset($_GET['id']) ? intval($_GET['id']) : 501;
...
<body>
    ...
    <div style="text-align: center; margin: 20px 0 10px;">
        ...
        <span
            style="font-size: 20px; font-weight: bold; color: #2A3B7E; vertical-align: middle; font-family: sans-serif;">Home
            & Living
            | IMarket</span>
    </div>
