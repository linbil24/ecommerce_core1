...
// Get product ID from URL, default to 101 if missing or invalid
...
<body>
    ...
    <div style="text-align: center; margin: 20px 0 10px;">
        ...
        <span
            style="font-size: 20px; font-weight: bold; color: #2A3B7E; vertical-align: middle; font-family: sans-serif;">Best-Selling
            | IMarket</span>
    </div>
